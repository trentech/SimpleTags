...
public class Commands {
	...
	private CommandSpec cmdTagPlayer = CommandSpec.builder()
		    ...
		    .arguments(//element, 
		    		GenericArguments.player(Text.of("player")), GenericArguments.optional(GenericArguments.string(Text.of("tag"))))
	...
	private CommandSpec cmdTagGroup = CommandSpec.builder()
		    ...
		    .arguments(//element, 
		    		new GroupElement(Text.of("group")), GenericArguments.optional(GenericArguments.string(Text.of("tag"))))
	...
	private CommandSpec cmdTagWorld = CommandSpec.builder()
		    ...
		    .arguments(//element, 
		    		GenericArguments.world(Text.of("world")), GenericArguments.optional(GenericArguments.string(Text.of("tag"))))
